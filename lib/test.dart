                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () {},
                                        style: ButtonStyle(
                                          backgroundColor: MaterialStateProperty.all(Color.fromARGB(190, 16, 192, 54)),
                                          minimumSize: MaterialStateProperty.all(Size(36, 36)), // Reduce the size
                                          maximumSize: MaterialStateProperty.all(Size(36, 36)), // Reduce the size
